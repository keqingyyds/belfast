...
const (
	// region / file
	URL_BASE            = "https://gh.xmly.dev/https://raw.githubusercontent.com/ggmolly/belfast-data/main/%s/%s"
	REGIONLESS_URL_BASE = "https://gh.xmly.dev/https://raw.githubusercontent.com/ggmolly/belfast-data/main/%s"
)
